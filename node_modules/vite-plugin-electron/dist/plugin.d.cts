import { l as getIsViteDev, o as RolldownOrRollupOptions } from "./index-B2DXpDtf.cjs";
import { Plugin } from "vite";

//#region src/plugin/notBundle.d.ts
interface NotBundleOptions {
  /**
...
*/
declare function extractExternalDeps(pkg: Record<string, any>): RolldownOrRollupOptions["external"];
/**
* @see https://github.com/vitejs/vite/blob/v4.4.7/packages/vite/src/node/utils.ts#L140
*/
declare const bareImportRE: RegExp;
/**
* During dev, we exclude the `cjs` npm-pkg from bundle, mush like Vite :)
*/
declare function notBundle(options?: NotBundleOptions): Plugin;
//#endregion
//#region src/plugin/esmShim.d.ts
declare function esmShim(): Plugin;
//#endregion
export { NotBundleOptions, bareImportRE, esmShim, extractExternalDeps, getIsViteDev, notBundle };