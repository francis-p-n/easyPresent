        ...
        content.innerHTML = `
          <div class="show-controls-section">
            <div class="empty-state">
              ${icon('layers', 32).outerHTML}
              <div class="empty-state__text">No props configured<br>Add logos, lower thirds, and overlays</div>
          ...
          <div class="show-controls-section">
            <div class="macro-grid">
              <button class="macro-btn" data-macro="worship-look">
                <span class="macro-btn__icon" style="background:#4a8cdb;">W</span>
                <span>Worship Look</span>
              </button>
              <button class="macro-btn" data-macro="sermon-look">
                <span class="macro-btn__icon" style="background:#e2a03f;">S</span>
                <span>Sermon Look</span>
              </button>
              <button class="macro-btn" data-macro="clear-all">
                <span class="macro-btn__icon" style="background:#d13438;">X</span>
                <span>Clear All</span>
              </button>
              <button class="macro-btn" data-macro="pre-service">
                <span class="macro-btn__icon" style="background:#379f00;">P</span>
