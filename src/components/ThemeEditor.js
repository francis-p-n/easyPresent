...
export function createThemeEditor() {
  ...
  selectGroup.innerHTML = '<label class="text-xs text-muted" style="display:block;margin-bottom:4px">Select Theme</label>'
  ...
  bgColorGroup.innerHTML = '<label class="text-xs text-muted" style="display:block;margin-bottom:4px">Background Color</label>'
  ...
  colorGroup.innerHTML = '<label class="text-xs text-muted" style="display:block;margin-bottom:4px">Text Color</label>'
  ...
  fontGroup.innerHTML = '<label class="text-xs text-muted" style="display:block;margin-bottom:4px">Font Family</label>'
